          ...
          <div className="p-4 md:w-1/3">
              <div className="h-full  rounded-lg overflow-hidden">
                ...
                <div className="p-6 bg-gray-600">
                  ...
                  <h1 className="title-font text-lg font-medium text-gray-100 mb-3">Dummny Blogs</h1>
                  ...
                  <div className="flex items-center flex-wrap ">
                    <a className="text-indigo-200 hover:bg-gray-400 hover:text-gray-800 inline-flex px-2 bg-black  p-2 items-center md:mb-2 lg:mb-0">Learn More
